...
let
  sources = {
    ...
    "svelte2tsx-0.7.28" = {
      ...
      version = "0.7.28";
      src = fetchurl {
        url = "https://registry.npmjs.org/svelte2tsx/-/svelte2tsx-0.7.28.tgz";
        sha512 = "TJjA+kU8AnkyoprZPgQACMfTX8N0MA5NsIL//h9IuHOxmmaCLluqhcZU+fCkWipi5c/pooHLFOMpqjhq4v7JLQ==";
      };
    };
    "tar-6.2.1" = {
      name = "tar";
