...
let
  sources = {
    ...
    "svelte2tsx-0.7.16" = {
      ...
      version = "0.7.16";
      src = fetchurl {
        url = "https://registry.npmjs.org/svelte2tsx/-/svelte2tsx-0.7.16.tgz";
        sha512 = "faI3t1N5I7RkrXGMLfUdfWg6DTPi8RisfES/00QzXh+faU2pQ3r/W2dUD0ENGh+qNzltIcjbfCW9PES9JkaSXg==";
      };
    };
    "tar-6.2.1" = {
      name = "tar";
