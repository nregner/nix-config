  ...
  graphql-language-service-cli = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (
        ...
        // {
          dependencies = [ sources."lru-cache-5.1.1" ];
        }
      )
      ...
      (sources."graphql-config-5.0.3" // { dependencies = [ sources."minimatch-4.2.3" ]; })
      ...
      (sources."postcss-8.4.39" // { dependencies = [ sources."source-map-js-1.2.0" ]; })
